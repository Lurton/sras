...
from core.constants import MEDIA_PERSONNEL_PREFIX, MEDIA_CAMPUS_PREFIX, MEDIA_RESIDENCE_PREFIX, MEDIA_ROOM_PREFIX
...
def get_document_upload_path(instance, filename):
    ...
    """
    from structure.models import Personnel, Campus, Residence, Room
